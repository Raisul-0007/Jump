      ...
      <Container className="flex justify-between items-center">
        ...
        <div className="w-1/4 flex gap-10 justify-center items-center">
          <div className="relative">
            <input
              type="text"
              className="bg-white py-2 rounded-lg focus:outline-none focus:ring-0 pl-3 pr-8 "
            />
          ...
          <Link to="/cart" className="text-white text-2xl relative">
            <IoMdCart />
            <div className="absolute -top-3 -right-3 h-4 w-4 flex items-center justify-center rounded-full bg-red-500 text-[12px]">
              {addToCart.length}
            </div>
          </Link>
        </div>
